...
values
  ('APP-20260801-A1000001', now() - interval '2 days', 'Aina Rahman', 'aina.rahman@example.test', '+60 12-000 1001', 'Shah Alam', 'Selangor', 'Sales Assistant', 'Two weeks', '2500', '2', 'Synthetic portfolio candidate.', 'Selangor', 'SETIAHUB (SHAH ALAM)', 'Yes', 'Applied', 0, array['New'], now() - interval '2 days', null),
  ('APP-20260802-A1000002', now() - interval '4 days', 'Daniel Tan', 'daniel.tan@example.test', '+60 12-000 1002', 'Kota Bharu', 'Kelantan', 'Cashier', 'Immediately', '2300', '1', 'Synthetic portfolio candidate.', 'Kelantan', 'SETIAHUB (KOTA BHARU)', 'No', 'Screening', 4, array['Retail'], now() - interval '1 day', null),
  ('APP-20260803-A1000003', now() - interval '7 days', 'Nur Izzati', 'nur.izzati@example.test', '+60 12-000 1003', 'Machang', 'Kelantan', 'Store Supervisor', 'One month', '3600', '5', 'Synthetic portfolio candidate.', 'Kelantan', 'SETIAHUB (MACHANG)', 'Yes', 'Interview', 5, array['Leadership'], now() - interval '1 day', null),
  ('APP-20260804-A1000004', now() - interval '9 days', 'Marcus Lee', 'marcus.lee@example.test', '+60 12-000 1004', 'Petaling Jaya', 'Selangor', 'Inventory Assistant', 'Immediately', '2800', '3', 'Synthetic portfolio candidate.', 'Selangor', 'SETIAHUB (SHAH ALAM)', 'No', 'Assessment', 4, array['Warehouse'], now() - interval '2 hours', null),
  ('APP-20260805-A1000005', now() - interval '12 days', 'Siti Hajar', 'siti.hajar@example.test', '+60 12-000 1005', 'Tumpat', 'Kelantan', 'Sales Assistant', 'Two weeks', '2600', '2', 'Synthetic portfolio candidate.', 'Kelantan', 'SETIAHUB (TUMPAT)', 'Yes', 'Offer', 5, array['Recommended'], now() - interval '1 day', null),
  ('APP-20260806-A1000006', now() - interval '15 days', 'Harith Zain', 'harith.zain@example.test', '+60 12-000 1006', 'Klang', 'Selangor', 'Cashier', 'Immediately', '2400', '2', 'Synthetic portfolio candidate.', 'Selangor', 'SETIAHUB (SHAH ALAM)', 'No', 'Hired', 5, array['Hired'], now() - interval '3 days', null),
  ('APP-20260807-A1000007', now() - interval '18 days', 'Priya Nair', 'priya.nair@example.test', '+60 12-000 1007', 'Kuala Lumpur', 'Kuala Lumpur', 'Marketing Executive', 'One month', '4200', '4', 'Synthetic portfolio candidate.', 'Selangor', 'HQ - Jenjarom', 'Yes', 'Rejected', 3, array['Portfolio'], now() - interval '4 days', null),
  ('APP-20260808-A1000008', now() - interval '5 days', 'Faris Hakim', 'faris.hakim@example.test', '+60 12-000 1008', 'Kota Bharu', 'Kelantan', 'Inventory Assistant', 'Two weeks', '2900', '3', 'Synthetic portfolio candidate.', 'Kelantan', 'SETIAHUB (KOTA BHARU)', 'No', 'Screening', 3, array['Operations'], now() - interval '2 days', null)
